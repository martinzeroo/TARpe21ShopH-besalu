...
{
    [DbContext(typeof(TARpe21ShopHõbesaluContext))]
    partial class TARpe21ShopHõbesaluContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TARpe21ShopHõbesalu.Core.Domain.FileToApi", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("TARpe21ShopHõbesalu.Core.Domain.FileToDatabase", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TARpe21ShopHõbesalu.Core.Domain.RealEstate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TARpe21ShopHõbesalu.Core.Domain.Spaceship", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TARpe21ShopHõbesalu.Core.Domain.FileToApi", b =>
                {
                    b.HasOne("TARpe21ShopHõbesalu.Core.Domain.RealEstate", null)
                        .WithMany("FilesToApi")
